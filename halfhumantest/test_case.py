...
class TestCases(unittest.TestCase):
    ...
    def test_03_stats_button(self):
        main_page = page.HomePage(self.driver)
        main_page.click_stats_button()
        if("Averages, Standard Deviations, etc." in self.driver.page_source):
            assert True
        else:
    ...
    def test_08_create_employee(self):
        ...
        data_results_page.gender_text_element = "F"
    ...
    def test_09_delete_employee(self):
        ...
        if(data_results_page.testName not in self.driver.page_source):
            print ("Did not add test employee, skipping test")
            assert False
        else:
            data_results_page.click_showID_button()
